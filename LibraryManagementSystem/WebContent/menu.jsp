...
<ul class="nav bg-dark mb-3">
	<li class="nav-item"><a href="insertStudent.jsp" class="nav-link">Add Student</a></li>
		<li class="nav-item"><a href="ListStudent.jsp" class="nav-link">Student List</a></li>
	<li class="nav-item"><a href="insertBook.jsp" class="nav-link">Add Book</a></li>
