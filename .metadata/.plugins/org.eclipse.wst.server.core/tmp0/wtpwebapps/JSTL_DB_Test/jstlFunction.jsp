...
<c:set var="str" value="min ko ko     ko    ko  ko"/>
<p>trimm of Length : ${fn:length(str)}</p>
<c:set var="str2" value="${fn:trim(str)}"/>
<p>trimm2 of length : ${fn:length(str2)}</p>
<p>The value is :${str2}</p>
</body>
</html>